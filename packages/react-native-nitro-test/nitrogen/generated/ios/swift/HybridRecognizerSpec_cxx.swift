...
open class HybridRecognizerSpec_cxx {
  ...
  // Properties
  public final var onResult: bridge.std__optional_std__function_void_const_std__string_____data______ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__function_void_const_std__string_____data______ in
        if let __unwrappedValue = self.__implementation.onResult {
          return bridge.create_std__optional_std__function_void_const_std__string_____data______({ () -> bridge.Func_void_std__string in
    ...
    @inline(__always)
    set {
      self.__implementation.onResult = { () -> ((_ data: String) -> Void)? in
        if bridge.has_value_std__optional_std__function_void_const_std__string_____data______(newValue) {
          let __unwrapped = bridge.get_std__optional_std__function_void_const_std__string_____data______(newValue)
