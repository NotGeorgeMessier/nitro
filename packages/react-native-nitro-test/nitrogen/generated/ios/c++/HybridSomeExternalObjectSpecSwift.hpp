...
namespace margelo::nitro::test {
  ...
  public:
    ...
    explicit HybridSomeExternalObjectSpecSwift(const NitroTest::HybridSomeExternalObjectSpec_cxx& swiftPart):
      HybridObject(HybridSomeExternalObjectSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroTest::HybridSomeExternalObjectSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroTest::HybridSomeExternalObjectSpec_cxx _swiftPart;
  };
